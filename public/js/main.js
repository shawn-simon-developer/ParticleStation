...
var game = function(GameOptions) {
	require(["Vector", "Particle", "Emitter", "Field", "Player"], function(Vector, Particle, Emitter, Field, Player) {
		...
		var maxParticles = GameOptions.maxParticles;
		var particleSize = GameOptions.particleSize;
		var emissionRate = GameOptions.emissionRate;
		var objectSize = GameOptions.objectSize; 
		var playerSize = GameOptions.playerSize;
